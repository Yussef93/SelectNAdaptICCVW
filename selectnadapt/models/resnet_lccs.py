...
@BACKBONE_REGISTRY.register()
def resnet18_lccs_ms_l123(pretrained=True, **kwargs):
...
@BACKBONE_REGISTRY.register()
def resnet101_lccs(pretrained=False, **kwargs):
    model = ResNet(block=Bottleneck, layers=[3, 4, 23, 3],norm_layer=LCCS)
